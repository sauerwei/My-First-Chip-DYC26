module highscore_bitmap(
    input  logic [4:0] y_offset,    // row in map (0-31)
    input  logic [7:0] x_offset,    // pixel in row (0-143)
    output logic       is_letter     // 1 = on, 0 = off
);
    logic [13:0] row_data;
    logic [3:0]  letter_idx;
    logic [3:0]  letter_x;

    always_comb begin
        row_data   = 14'b0;
        letter_idx = x_offset[7:4]; // 16px Zelle = 14px Buchstabe + 2px Abstand
        letter_x   = x_offset[3:0];

        if (y_offset < 5'd14 && letter_x < 4'd14) begin
            case (letter_idx)
            4'd0,
            4'd3: begin // Buchstabe: H
                case (y_offset[3:0])
            ...
            4'd1: begin // Buchstabe: I
                case (y_offset[3:0])
                    4'd0:  row_data = 14'b00111111111100; 
                    4'd1:  row_data = 14'b00111111111100;
                    4'd2:  row_data = 14'b00000111100000; 
                    4'd3:  row_data = 14'b00000111100000;
                    4'd4:  row_data = 14'b00000111100000;
                    4'd5:  row_data = 14'b00000111100000;
                    4'd6:  row_data = 14'b00000111100000;
                    4'd7:  row_data = 14'b00000111100000;
            ...
            4'd2: begin // Buchstabe: G
                case (y_offset[3:0])
                    4'd0:  row_data = 14'b00111111111100;
                    4'd1:  row_data = 14'b00111111111100;
                    4'd2:  row_data = 14'b11110000000011;
                    4'd3:  row_data = 14'b11110000000011;
            ...
            4'd4: begin // Buchstabe: S
                case (y_offset[3:0])
                    ...
                    4'd8:  row_data = 14'b00000000001111;
                    4'd9:  row_data = 14'b00000000001111;
                    4'd10: row_data = 14'b11000000001111;
                    4'd11: row_data = 14'b11000000001111;
                    4'd12: row_data = 14'b00111111111100;
                    4'd13: row_data = 14'b00111111111100;
                    default: row_data = 14'b0;
                endcase
            ...
            4'd5: begin // Buchstabe: C
                case (y_offset[3:0])
                    ...
                    4'd4:  row_data = 14'b11110000000000;
                    4'd5:  row_data = 14'b11110000000000;
                    4'd6:  row_data = 14'b11110000000000;
                    4'd7:  row_data = 14'b11110000000000;
                    4'd8:  row_data = 14'b11110000000000;
                    4'd9:  row_data = 14'b11110000000000;
                    4'd10: row_data = 14'b11110000000011;
                    4'd11: row_data = 14'b11110000000011;
                    4'd12: row_data = 14'b00111111111100;
                    4'd13: row_data = 14'b00111111111100;
                    default: row_data = 14'b0;
                endcase
